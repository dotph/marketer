# Verified by dotPH — Execution Flow: Awareness to Conversion

**Product:** Verified by dotPH — free trust & identity verification for .ph domain holders
**Purpose:** Visualize how prospects move from unaware to signed up across all channels
...
### Warm Email Flow (Existing .ph Domain Holders)
...
### Cold Outreach Flow (New Prospects)
...
## 3. Cross-Channel Reinforcement Map
...
## 4. Prospect Journeys — 4 Industries, 4 Paths

Each journey shows a different entry point, a different industry, and a different path to conversion.

---

### Journey A: Resort Owner in Palawan

**Entry point:** Facebook Ad (Awareness)
**Industry pain:** Fake booking pages collecting deposits from real guests
...
### Journey B: Online Seller in Manila

**Entry point:** Warm Email (existing .ph domain holder)
**Industry pain:** Customers can't verify which GCash number is real
...
### Journey C: Dental Clinic in Cebu

**Entry point:** Cold Email
**Industry pain:** Patients calling a fake clinic number from a copycat Google listing
...
### Journey D: Food Seller on Social Media

**Entry point:** Facebook Ad (Awareness)
**Industry pain:** Fake delivery pages taking orders under her brand name
...
## 7. Emotional Arc Across the Funnel
...
## 8. Full System View — One Diagram
